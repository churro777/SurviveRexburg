...
public class AcceptItemFromSurvivorsFrame extends javax.swing.JFrame {
     ...
     */
    public AcceptItemFromSurvivorsFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jRadioButton4.setText("Fortify Location");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AcceptItemFromSurvivorsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AcceptItemFromSurvivorsFrame().setVisible(true);
            }
        });
    }
