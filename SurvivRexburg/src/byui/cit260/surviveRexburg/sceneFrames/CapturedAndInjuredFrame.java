 ...
 * @author carissa888
 */
public class CapturedAndInjuredFrame extends javax.swing.JFrame {

    /**
     * Creates new form CapturedAndInjuredFrame
     */
    public CapturedAndInjuredFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapturedAndInjuredFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapturedAndInjuredFrame().setVisible(true);
            }
        });
    }
