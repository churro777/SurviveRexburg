 ...
 * @author carissa888
 */
public class DefeatZombiesFrame extends javax.swing.JFrame {

    /**
     * Creates new form DefeatZombiesFrame
     */
    public DefeatZombiesFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("You killed all the zombies. That could have been bad.");
        ...
        jLabel4.setText("Health: " + SurviveRexburg.getEndUser().getHealth());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DefeatZombiesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DefeatZombiesFrame().setVisible(true);
            }
        });
    }
