 ...
 * @author carissa888
 */
public class ZombieAttackFrame extends javax.swing.JFrame {

    /**
     * Creates new form ZombieAttackFrame
     */
    public ZombieAttackFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ZombieAttackFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ZombieAttackFrame().setVisible(true);
            }
        });
    }
