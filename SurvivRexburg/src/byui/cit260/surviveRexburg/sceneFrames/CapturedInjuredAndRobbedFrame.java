 ...
 * @author carissa888
 */
public class CapturedInjuredAndRobbedFrame extends javax.swing.JFrame {

    /**
     * Creates new form CapturedInjuredAndRobbedFrame
     */
    public CapturedInjuredAndRobbedFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CapturedInjuredAndRobbedFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CapturedInjuredAndRobbedFrame().setVisible(true);
            }
        });
    }
