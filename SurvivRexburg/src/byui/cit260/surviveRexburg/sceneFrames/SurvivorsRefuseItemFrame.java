 ...
 * @author carissa888
 */
public class SurvivorsRefuseItemFrame extends javax.swing.JFrame {

    /**
     * Creates new form SurvivorsRefuseItemFrame
     */
    public SurvivorsRefuseItemFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("They don't like what you are offering. You can't stall or distract them any longer. What are you going to do?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SurvivorsRefuseItemFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SurvivorsRefuseItemFrame().setVisible(true);
            }
        });
    }
