 ...
 * @author carissa888
 */
public class DayEndFrame extends javax.swing.JFrame {

    /**
     * Creates new form DayEndFrame
     */
    public DayEndFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DayEndFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DayEndFrame().setVisible(true);
            }
        });
    }
