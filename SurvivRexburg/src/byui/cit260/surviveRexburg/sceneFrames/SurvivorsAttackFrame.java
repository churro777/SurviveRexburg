 ...
 * @author carissa888
 */
public class SurvivorsAttackFrame extends javax.swing.JFrame {

    /**
     * Creates new form SurvivorsAttackFrame
     */
    public SurvivorsAttackFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SurvivorsAttackFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SurvivorsAttackFrame().setVisible(true);
            }
        });
    }
