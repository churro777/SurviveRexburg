 ...
 * @author carissa888
 */
public class SurvivorsLeaveFrame extends javax.swing.JFrame {

    /**
     * Creates new form SurvivorsLeaveFrame
     */
    public SurvivorsLeaveFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("The group of survivors leave you alone.");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SurvivorsLeaveFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SurvivorsLeaveFrame().setVisible(true);
            }
        });
    }
