 ...
 * @author carissa888
 */
public class DefeatSurvivorsFrame extends javax.swing.JFrame {

    /**
     * Creates new form DefeatSurvivorsFrame
     */
    public DefeatSurvivorsFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("You did what you had to. You survived. They attacked and you defended yourself");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DefeatSurvivorsFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DefeatSurvivorsFrame().setVisible(true);
            }
        });
    }
