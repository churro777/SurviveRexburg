 ...
 * @author carissa888
 */
public class KilledByHungerFrame extends javax.swing.JFrame {

    /**
     * Creates new form KilledByHungerFrame
     */
    public KilledByHungerFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KilledByHungerFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new KilledByHungerFrame().setVisible(true);
            }
        });
    }
