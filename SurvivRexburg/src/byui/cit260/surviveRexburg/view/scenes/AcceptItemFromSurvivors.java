 ...
 * @author arturoaguila
 */
public class AcceptItemFromSurvivors extends View{

    public AcceptItemFromSurvivors() {
        super(    "\n================================="
                + "\n-----You Accept The Supplies-----"
                + "\n================================="
                + "\n You got some supplies! Make sure"
                + "\n you make them last. What a great"
                + "\n day. Time for sleep."
                + "\n================================="
                + "\n1 - End Day"
                + "\n"
