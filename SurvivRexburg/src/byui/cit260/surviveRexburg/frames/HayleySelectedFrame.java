 ...
 * @author carissa888
 */
public class HayleySelectedFrame extends javax.swing.JFrame {

    /**
     * Creates new form HayleySelectedFrame
     */
    public HayleySelectedFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        gameMenuHeading.setText("You Chose Hayley");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HayleySelectedFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HayleySelectedFrame().setVisible(true);
            }
        });
    }
