 ...
 * @author carissa888
 */
public class MeganSelectedFrame extends javax.swing.JFrame {

    /**
     * Creates new form MeganSelectedFrame
     */
    public MeganSelectedFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Are you sure? Good choice!");
        ...
        gameMenuHeading.setText("You Chose Megan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MeganSelectedFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MeganSelectedFrame().setVisible(true);
            }
        });
    }
